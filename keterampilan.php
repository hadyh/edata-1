    ...
    <section class="content container-fluid">
         <div class="box container">
            <div class="box-header">
                <h1>Nilai Keterampilan Kelas : <?= $_GET['nama_kelas'];?> </h1>
            </div>
            ...
            if (isset($_POST['insert_nilai'])){
              ...
              $search_content = $db->select("*","nilai","nis='$nis' and no_kd='$no_kd' and type='kt'");

              $count_result = $db->getTableRows($search_content);

              if ($count_result == 0 ){
                $q = $db->insert("nilai","nis,no_kd,nilai,type","'$nis','$no_kd','$nilai','kt'");
            ...
            if (isset($_POST['edit_nilai'])){
              ...
              $update = $db->update("nilai","nilai='$nilai'","nis='$nis' and no_kd='$no_kd'");
                     ...
                     echo "tidak ada data";
                      ...
                      while ($row = $db->fetch($q)){
                        ...
                        echo "<tr>
                              ...
                              $select_kd = $db->select("*","kd","no_ki=4");
                              ...
                              while ($data_kd = $db->fetch($select_kd)) {
                                 ...
                                 echo "<tr><td>".
                                  ...
                                  $src_nilai = $db->select("*","nilai","nis='$nis' and no_kd='$no_kd_inner' and type='kt'");
